...
public class LocationControl {
    ...
    public static Location[][] assignScenesToLocations(Map map, Scene[] scenes) {
        ...
        locations[0][5].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.gatherSpaceChickens.ordinal()]);
        locations[0][6].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere1.ordinal()]);
        locations[1][0].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere2.ordinal()]);
        locations[1][1].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere3.ordinal()]);
        locations[1][2].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere4.ordinal()]);
        locations[1][3].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere5.ordinal()]);
        locations[1][4].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere6.ordinal()]);
        locations[1][5].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere7.ordinal()]);
        locations[1][6].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere8.ordinal()]);
        locations[2][0].setScene(scenes[JobBoardSceneControl.JobBoardSceneList.insertJobSceneHere9.ordinal()]);
